...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  ...
  <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary">
    <div class="col-md-6 p-lg-5 mx-auto my-5">
      <h1 class="display-3 fw-bold">{{ t('home_text.home1') }}</h1>
      <h3 class="fw-normal text-muted mb-3">{{ t('home_text.home2') }}</h3>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden text-white" style="background-color: #012615;">
      <div class="my-3 py-3">
        <h2 class="display-5">{{ t('home_text.home4') }}</h2>
        <p class="lead">{{ t('home_text.home5') }}</p>
      </div>
    ...
    <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">{{ t('home_text.home6') }}</h2>
        <p class="lead">{{ t('home_text.home7') }}</p>
      </div>
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="bg-body-tertiary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
      <div class="my-3 p-3">
        <h2 class="display-5">{{ t('home_text.home8') }}</h2>
        <p class="lead">{{ t('home_text.home9') }}</p>
      </div>
    ...
    <div class="me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden text-white" style="background-color: #012615;">
      <div class="my-3 py-3">
        <h2 class="display-5">{{ t('home_text.home10') }}</h2>
        <p class="lead">{{ t('home_text.home11') }}</p>
      </div>
